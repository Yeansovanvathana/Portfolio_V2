                ...
                <div className="relative p-10 bg-primary-200 w-full ">
                    <div className="grid grid-cols-1 md:grid-cols-3 auto-cols-max ">
                        ...
                        <div className="my-10 space-y-5 md:p-3 lg:p-10 lg:border-primary-100 md:border-2 rounded-l-3xl md:col-span-2 ">
                            ...
                            <p className="text-base">
                                I am a self-motivated and inpendent with a
                                strong ability to adapt to various situation. I
                                am committed to continual learning and am alway
                                looking to expand my skillset I have gained
                                extensive experience in development, I am
                                confident in my ability to work collaboratively
                                or independently to achieve project goals.{" "}
                            </p>
                    ...
                    <div>
                        ...
                        <div className="space-y-3 mt-6">
                            ...
                            <p className="font-normal text-base">
                                {" "}
                                I finished in the top 20 of a challenging
                                programming-solving competition with four
                                rounds, where I honed my problem-solving,
                                critical thinking and programming skill, This
                                experience also taught me how to work well under
                                pressure and the importance of self-learning{" "}
                            </p>
                        </div>
                    </div>
                </div>
