  ...
  return (
    ...
    >
      <div className="max-w-screen-xl mx-auto lg:px-32 w-full mt-24 lg:p-5 px-8">
        ...
        <div className="relative p-6 bg-primary-200 w-full dark:bg-gray-600">
          <div className="grid grid-cols-1 md:grid-cols-3 auto-cols-max ">
            ...
            />
            <div className="my-10 space-y-5 md:p-3 lg:p-10 md:border-primary-100 md:border-2 rounded-l-3xl md:col-span-2 max-w-prose text-justify">
          ...
          <div>
            ...
            <div className="space-y-3 mt-6">
              ...
              <div className="space-y-1">
                <h3 className="uppercase font-bold text-base ">Diploma</h3>
                <div>
                  <p className="font-semibold md:text-lg">
