        ...
        <div className="z-30 mt-6 lg:-mt-4">
            ...
            >
                ...
                <div className="lg:px-5 py-2 ">
                    ...
                    <p className="lg:max-w-[320px] max-w-[320px] text-center lg:text-start text-gray-500 text-sm">
                        The poster design you provided surpassed our
                        expectations! It beautifully captured the essence of our
                        brand and received many new customer.
                    </p>
                </div>
                <div>
                    <div className="py-1">
                        <h2 className="text-center lg:text-start py-1 text-sm">
                            Quality
                        </h2>
                    ...
                    <div className="py-1">
                        <h2 className="py-1 text-sm lg:text-start">
                            Communication
                        </h2>
                        <div className="w-full h-2.5 bg-secondary-100 rounded-lg">
            ...
            >
                ...
                <div className="lg:px-5 py-2 ">
                    ...
                    <p className="lg:max-w-[320px] max-w-[400px] text-center lg:text-start text-gray-500 text-sm">
                        Thank you for the exceptional poster design. It truly
                        stood out and connected with our intended audience.
                    </p>
                </div>
                <div>
                    <div className="py-1">
            ...
            <motion.div
                ...
                className="flex flex-col lg:flex-row bg-primary-200 rounded-lg shadow justify-center items-center m-auto py-2  px-4"
            >
                <div className="w-14 h-14 relative">
                    <Image
                ...
                <div className="lg:px-5 py-2 ">
                    ...
                    <p className="lg:max-w-[320px] max-w-[400px] text-center lg:text-start text-gray-500 text-sm">
                        Your service delivered an excellent banner that
                        effectively communicates our message to customers.
                    </p>
                </div>
                <div>
                    <div className="py-1">
                        <h2 className="py-1 text-center lg:text-start text-sm">
                            Quality
                        </h2>
                        <div className="w-full h-2.5 bg-secondary-100 rounded-lg">
                            <div className="w-[90%] h-full bg-green-600 rounded-lg transition-all duration-500 hover:w-full"></div>
