            ...
            <div className="flex-col justify-center items-center w-full ">
                <div className="lg:flex md:flex justify-between max-w-screen-xl mx-auto z-20 lg:px-20">
                    <div className="p-10 text-center lg:text-start md:text-start ">
                        ...
                        >
                            I specialize in developing and designing innovative
                            digital solutions, combining my skills in coding and
                            visual aesthetics to create seamless and
                        ...
                        >
                            <AiFillGithub
                                onClick={() => {
                                    window.open(
                                        "https://github.com/Yeansovanvathana",
                                        "_blank"
                                    );
                                }}
                    ...
                    >
                        <div className="bg-primary-200 w-48 h-80 rounded-3xl relative">
