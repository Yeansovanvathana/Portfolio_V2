    ...
    <section id="home" className="gap-16 py-10 mt-10 md:mt-0 lg:h-screen">
      <div className="flex-col justify-center items-center md:py-5 md:pt-5">
        <div className="lg:flex md:flex justify-between max-w-screen-xl mx-auto z-20 xl-items-center md:mt-24 py-10">
          ...
          >
            <div className="bg-primary-200 w-48 h-80 rounded-3xl relative lg:w-56 lg:h-96">
              <div className="w-48 h-80 rounded-3xl absolute overflow-hidden right-5 -top-5 lg:w-56 lg:h-96">
                <Image
                  src="/Vathana.jpg"
                  width={300}
                  height={300}
          ...
          <div className="border bg-gray-100 w-4/6 h-24 rounded-xl grid grid-cols-3 divide-x divide-gray-300">
            <div className="flex flex-col justify-center items-center ">
              <div className="flex flex-row items-center gap-3">
                ...
                <h1 className="text-3xl font-medium">2.5</h1>
              </div>
              <h3 className="text-gray-500 text-sm">Years Experience</h3>
            </div>
            <div className="flex flex-col justify-center items-center ">
              <div className="flex flex-row items-center gap-3 py-1">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 512 512"
                  className="lg:w-10 lg:h-10 h-8 w-8 animate-pulse"
                  style={{ fill: "gray" }}
                >
              ...
              <h3 className="text-gray-500 text-sm">Complete Projects</h3>
            </div>
            <div className="flex flex-col justify-center items-center ">
              <div className="flex flex-row items-center gap-3">
                <svg
              ...
              <h3 className="text-gray-500 text-sm">Design Clients</h3>
            </div>
          </div>
        </motion.div>
      </div>
