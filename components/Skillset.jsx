            ...
            <div className="space-y-4">
              <div className="Card2 gap-2 md:w-48">
                <Image
                  ...
                  alt=""
                />
                <p className="text-[11px] md:text-base">Adobe Photoshop</p>
              </div>
              <div className="Card2 md:w-48">
                <Image
                  ...
                  alt=""
                />
                <p className="text-[11px] md:text-base">Adobe Illustrator</p>
              </div>
              <div className="Card2 md:w-48">
                <Image
                  width={300}
            ...
            <div className="space-y-4">
              <div className="Card2 md:w-48">
                <Image
                  ...
                  alt=""
                />
                <p className="text-[11px] md:text-base">Adobe Lightroom</p>
              </div>
              <div className="Card2 md:w-48">
                <Image
                  width={300}
